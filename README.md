...
- Claim автоматически запрашивается при создании новой сессии (команда «новая сессия» или `/voicer-claim`)
- Используйте `/voicer claim` для явного переключения на этот экземпляр
- Используйте `/voicer release` для отказа от claim
...
| `voicer_release` | Отказаться от роли активного получателя голосового ввода |
